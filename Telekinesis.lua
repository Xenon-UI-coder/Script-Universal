--[[
	E - increases your telekinesis range by 2.5 studs (the part will be held at max range)
	X - makes your range 5 studs
	Y - makes your range 50 studs
	J - kills the part by making your range 5000 studs
]]
...
table.insert(cors,sandbox(LocalScript3,function()
	...
	hookBP.maxForce=_VTR_new(300000,300000,300000) 
