...
Watermark.Text = "Super Ring [V3] - Cracked By ???"
...
--SendChatMessage("Super Ring Parts Cracked By AOC Executed! ✨")
--SendChatMessage("Original Creator Script Is ChatGPT So Fire 🔥🔥🔥")